            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="xl:max-w-7xl lg:max-w-5xl md:max-w-5xl mx-auto grid grid-cols-2 md:grid-cols-2 xl:grid-cols-4 gap-2 md:gap-10 lg:gap-13 ">
                    {hiringFeatures.map((feature, index) => (
                        <Card key={index} className="bg-white border border-[rgba(58,63,187,0.5)] p-0 lg:py-17 md:py-14 py-3 px-[2px] md:px-3 lg:px-3 gap-0 shadow-none rounded-lg w-full h-full ">
