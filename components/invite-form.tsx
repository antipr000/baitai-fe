      ...
      <DialogContent className="sm:max-w-xl">
        <DialogHeader className="items-start text-left">
          <div className="flex items-center gap-2 mb-1">
            ...
            <DialogTitle className="text-xl font-semibold text-[rgba(10,13,26,1)]">Send Interview Invites</DialogTitle>
          </div>
        ...
        <form className="flex flex-col gap-6 mt-4" onSubmit={handleSubmit}>
          ...
          <div className="flex flex-col gap-2">
            <label htmlFor="emails" className="text-sm font-semibold text-[rgba(10,13,26,1)]">
              Email Addresses
            </label>
            <Input
              id="emails"
              className="bg-blue-50/30 border-blue-100 focus-visible:ring-[rgba(58,63,187,1)] placeholder:text-[rgba(10,13,26,0.6)]"
          ...
          <div className="flex flex-col gap-2">
            <label htmlFor="message" className="text-sm font-semibold text-[rgba(10,13,26,1)]">
              Custom Message (Optional)
            </label>
            <Textarea
              id="message"
              className="min-h-[120px] bg-blue-50/30 border-blue-100 focus-visible:ring-[rgba(58,63,187,1)] placeholder:text-[rgba(10,13,26,0.6)] resize-none"
          ...
          <DialogFooter className="flex gap-3 sm:justify-end mt-2">
            ...
            <Button
              ...
              className="bg-[rgba(58,63,187,1)] border  hover:border-[rgba(58,63,187,1)] hover:bg-white text-white hover:text-[rgba(58,63,187,1)] w-full sm:w-auto px-6 gap-2"
            >
