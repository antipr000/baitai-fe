    ...
    return (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
            ...
            <Card className="border border-[rgba(58,63,187,1)] shadow-sm bg-white rounded-[12px]">
                <CardContent className="">
                    <div className="flex items-center gap-4">
                        <Image src="/candidate/practice-inteviews2/all.svg" alt="All" width={24} height={24} />
                        <div>
            ...
            <Card className="border border-[rgba(58,63,187,1)] shadow-sm bg-white rounded-[12px]">
                <CardContent className="">
                    <div className="flex items-center gap-4">
                        <Image src="/candidate/practice-inteviews2/easy.svg" alt="Easy" width={24} height={24} />
                        <div>
            ...
            <Card className="border border-[rgba(58,63,187,1)] shadow-sm bg-white rounded-[12px]">
                <CardContent className="">
                    <div className="flex items-center gap-4">
                        <Image src="/candidate/practice-inteviews2/medium.svg" alt="Medium" width={24} height={24} />
                        <div>
            ...
            <Card className="border border-[rgba(58,63,187,1)] shadow-sm bg-white rounded-[12px]">
                <CardContent className="">
                    <div className="flex items-center gap-4">
                        <Image src="/candidate/practice-inteviews2/hard.svg" alt="Difficult" width={24} height={24} />
                        <div>
