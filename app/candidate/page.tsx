                ...
                <div className="max-w-7xl mx-auto p-6 space-y-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                        ...
                        <Card className="bg-[rgba(254,118,168,0.1)] border border-[rgba(252,183,50,0.5)]">
                            <CardContent className="pt-6">
                                <div className="group flex items-center justify-between">
                                    <Image src="/candidate/pending.svg" className='group-hover:-rotate-10 transition-all duration-400' alt="Pending" width={32} height={32} />
                                    <div>
                        ...
                        <Card className="bg-[rgba(252,183,50,0.1)] border border-[rgba(252,183,50,0.5)]">
                            <CardContent className="pt-6">
                                <div className="group flex items-center justify-between">
                                    <Image src="/candidate/score.svg" className='group-hover:-rotate-10 transition-all duration-400' alt="score" width={32} height={32} />
                                    <div>
                        ...
                        <Card className="bg-[rgba(224,83,83,0.1)] border border-[rgba(224,83,83,0.5)]">
                            <CardContent className="pt-6">
                                <div className="group flex items-center justify-between">
                                    <Image src="/candidate/time.svg" className='group-hover:-rotate-10 transition-all duration-400' alt="time" width={32} height={32} />
                                    <div>
